...
export default function ContactPage() {
  useSEO({
    title: "Contact — pictureprefect",
    description: "Get in touch with pictureprefect. Questions about presets, custom orders, or collaborations — we'd love to hear from you.",
    path: "/contact",
  });
            ...
            {[
              {
                ...
                label: "Email",
                value: "hello@pictureprefect.com",
                href: "mailto:hello@pictureprefect.com",
              },
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
