...
export default function ShopPage() {
  useSEO({
    title: "Shop Presets — pictureprefect",
    description: "Browse the full pictureprefect collection. Luxury Lightroom preset packs designed for Indian wedding photographers — instant download, XMP + DNG formats.",
    path: "/shop",
  });
  const [, setLocation] = useLocation();
